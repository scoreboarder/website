      ...
      <div className="w-full xl:w-3/4 max-w-6xl flex flex-col space-y-32">
        ...
        <article className=" text-white space-y-12">
          <div className="prose text-slate-300">
            ...
            <p>
              Through inviting, the bot may collect specific data as described
              in its Privacy Policy. This data's intended usage is for the bot's
              core functionalities, such as executing commands.
            </p>
            <p>
          ...
          <div className="prose text-slate-300">
            ...
            <p>
              Any direct connection to Discord or any of its Trademark objects
              is purely coincidental. We do not claim copyright ownership of
          ...
          <div className="prose text-slate-300">
            ...
            <p>
              The bot is not permitted for minors under the age of 13 or under
              the legal consent of their country
            </p>
            <p>
              This complies with the Discord Terms of Service. No information
              will be knowingly stored from an underage user. If it is found out
              that a user is underage, we will take all necessary actions to
          ...
          <div className="prose text-slate-300">
            ...
            <p>
              The bots developers and owner may not be made liable for
              individuals breaking these Terms at any given time.
            </p>
            <p>
